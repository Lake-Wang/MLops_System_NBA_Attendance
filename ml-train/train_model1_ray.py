...
# Set ml-flow experiment on model 1
...
print(f"Test R^2: {test_r2:.4f}, Test RMSE: {test_rmse:.4f}, Test Model MSE Loss: {test_loss:.4f}")
...
# Write to .csv
result_df.to_csv('model1_out.csv', index=False)